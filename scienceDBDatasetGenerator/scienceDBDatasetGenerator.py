...
class NewDataset(datasets.GeneratorBasedBuilder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.features = datasets.Features({
            "txt_text": datasets.Value(dtype="string"),
            "json_text": datasets.Value("string"),
            "json_label": datasets.Value("string"),
            "csv_column1": datasets.Value("string"),
            "csv_column2": datasets.Value("string"),
